...
| **Вставити текст** | Права кнопка, або `CTRL + SHIFT + V` |
| **Вставити зображення** | `CTRL + SHIFT + I` (див. вище) |

> `CTRL+C` — це сигнал переривання (вбиває команду). `CTRL+V` часто перехоплюється програмою всередині термінала. Використовуйте `CTRL+SHIFT+C` / `CTRL+SHIFT+V`. Але якщо ви виділили текст мишею — він уже в буфері обміну.
