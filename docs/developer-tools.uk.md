...
- **Опис:** Виконуйте команди у спільному вікні терміналу прямо з OpenCode.
- **Документація:** [Довідник спільного терміналу](shared-terminal.uk.md)
- **Гарячі клавіші WezTerm:**
  - Команди надсилаються у спільну панель (знизу зліва у стандартному макеті розробника).
